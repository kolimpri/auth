...
use Kolimpri\Auth\Teams\Team;
use Kolimpri\Auth\Contracts\Repositories\TeamRepository as Contract;
...
class TeamRepository implements Contract
{
     ...
     * @param  array  $data
     * @return \Kolimpri\Auth\Teams\Team
     */
    public function create($user, array $data)
    {
        $class = kAuth::model('teams', Team::class);
