...
<body>
    <!-- Main Content -->
    <div class="container auth-splash-screen">
        <!-- Branding / Navigation -->
        <div class="row splash-nav">
            <div class="col-md-10 col-md-offset-1">
                <div class="pull-left splash-brand">
                    <i class="fa fa-btn fa-sun-o"></i>Laravel Auth
                </div>
        ...
        <div class="row splash-inspiration-row">
            <div class="col-md-4 col-md-offset-1">
                ...
                <div id="splash-inspiration-text">
                    Auth provides the perfect starting point for your next big idea. Forget all the
        ...
        <div class="row splash-features-icon-row">
            <div class="col-md-10 col-md-offset-1 text-center">
                <div class="col-md-4 splash-features-feature">
                    ...
                    <div class="splash-feature-text">
                        Auth provides simple, built-in support for creating and managing teams and invitations.
                    </div>
                </div>
                ...
                <div class="col-md-4 splash-features-feature">
                    ...
                    <div class="splash-feature-text">
                        Customize or replace any of the views provided with Auth and make the design your own.
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1 splash-footer">
                <div class="pull-left splash-footer-company">
                    Copyright © {{ kAuth::company() }} - <a href="/terms">Terms Of Service</a>
                </div>
