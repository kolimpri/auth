<!-- Main Content -->
<auth-team-settings-membership-screen inline-template>
	<div>
			...
			<div class="panel panel-default" v-if="userOwns(team)">
				...
				<div class="panel-body">
					<form method="POST" class="form-horizontal" role="form">
						<auth-errors form="@{{ sendInviteForm }}"></auth-errors>
	...
	@include('auth::settings.team.tabs.membership.modals.edit-team-member')

</auth-team-settings-membership-screen>
