<auth-settings-profile-screen inline-template>
	<div id="auth-settings-profile-screen" class="panel panel-default">
		<div class="panel-heading">Update Profile</div>

		<div class="panel-body">
			<auth-errors form="@{{ updateProfileForm }}"></auth-errors>
